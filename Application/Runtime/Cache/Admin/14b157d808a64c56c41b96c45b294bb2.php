...
<form action="" method="post" enctype="multipart/form-data"><!--Action由于是提交给当前页面处理的，所以action可以不写-->
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>作者：</label>
        <input name="author" type="text" value="<?php echo ($username); ?>" placeholder="作者..." />
    </p>
    <p class="short-input ue-clear">
    	<label>内容：</label>
